...
class LigandPrep:
    ...
    def smile2sdf(self, output_file: str):
        ...
        """
        # 添加3D坐标
        output_file_pdbqt = output_file.split(".")[-1] + '.pdbqt'
        output_file_aligned_sdf = output_file.split(".")[-1] + '_aligned.pdb'
        output_file_aligned_pdbqt = output_file.split(".")[-1] + '_aligned.pdbqt'
